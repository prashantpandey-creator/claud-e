...
TEST_PASS=true
for tf in test_sessions.py test_launch.py test_scan.py test_still.py test_doctor.py test_nidra_bridge.py test_metrics.py test_hook.py test_coordination.py test_archive.py; do
